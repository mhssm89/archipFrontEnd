...
function Form({ className, poq, ...rest }) {
  ...
  const methods = useForm({
    ...
    defaultValues: {
      number: poq.number || '',
      customerName: poq.customerName || null,
      startDate: poq.startDate || new Date(),
      endDate: poq.endDate || new Date(),
      shippingAddress: poq.shippingAddress || '',
      shippingCost: poq.shippingCost || 0,
      otherCosts: poq.otherCosts || 0,
      totalCost: poq.totalCost || 0,
      submitError: '',
    },
  });
  const {
