...
// import { deleteProductClass, updateProductClass } from 'src/graphql/mutations';
...
function Results({ className, query, queryName, ...rest }) {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Card>
        <CardHeader title="Product Classes" />
        <Divider />
        <PerfectScrollbar>
          <Box minWidth={1150}>
            <Table>
                    ...
                    return (
                      <TableRow
                        ...
                        <TableCell align="right">
                          <IconButton
                            component={Link}
                            href={`/product-classes/${item.id}/edit`}>
