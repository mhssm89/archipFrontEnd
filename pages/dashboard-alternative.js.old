...
function DashboardAlternativePage() {
...
DashboardAlternativePage.Guard = Protected;
DashboardAlternativePage.Layout = DashboardLayout;

export default DashboardAlternativePage;
