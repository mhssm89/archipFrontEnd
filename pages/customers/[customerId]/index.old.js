      ...
      {isLoading ? (
        ...
        <Page className={classes.root} title="Customers - Edit">
          <Container maxWidth={false}>
            ...
            <h1>view customer detail here</h1>
          </Container>
...
CustomerViewPageold.Guard = Protected;
CustomerViewPageold.Layout = DashboardLayout;

export default CustomerViewPageold;
